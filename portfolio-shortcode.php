   ...
   extract(shortcode_atts(array(
	...
	{ 
        ...
        while ($query->have_posts()) 
		{
                    ...
                    $pf_imgArray = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'portfolio-homepage');
                    $large_imgArray = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'portfolio-homepagelarge');
					...
					$sub_title = explode(' ',$full_title, 2); 
                     ...
                     $html .='<figure class="col-xs-6 col-sm-3 col-md-3 effect-apollo">';
						 if( !empty( $pf_imgURL ) ){
						         ...
						         $html .='<figcaption>';
						            if(isset($sub_title[0]) && isset($sub_title[1]))
						            {
