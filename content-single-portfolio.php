...
$cnt = 0;
$blog_detail_url = get_the_permalink(get_the_ID());
if(!empty($term->name)){
...
<article class="col-xs-12 col-sm-6 col-md-4 project-detail wow fadeInRight animated" data-wow-delay="0.3s"> 
    <?php
        ...
        {
            echo '<h4 class="title"><strong>'. $sub_title[0] .'</strong></h4>';
        }
        else
        {
            echo '<h4 class="title"><strong>'. $sub_title[0] .'</strong>' .$sub_title[1]. '</h4>';
        }
    ?>
