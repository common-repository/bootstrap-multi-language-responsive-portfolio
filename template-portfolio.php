...
$wpt_page_id = get_option('portfolio-page');
$post = get_post($wpt_page_id); 
...
<div class="container">
    <article class="row"> 
    <section class="recent_project clearfix wpt-text-block">
    	<div class="title-area">	
			<h2 class="section-title"><?php echo $title; ?></h2>
			<div class="section-divider divider-inside-top"></div>
		</div>
    	<div class="section-sub-text"><?php echo $content; ?></div>
    </section>
